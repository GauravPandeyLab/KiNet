...
The dropdown menu lists `r ndomains` out of `r ndomains_all` domains from the `r interpro_name` gene set library provided by [Enrichr](https://maayanlab.cloud/Enrichr/). 

The selected domains' gene sets were identified to be significantly enriched against the kinase substrates in the KinAce dataset using [GSEApy](https://github.com/zqfang/GSEApy/) <i>`r gseapy_release`</i>. 
