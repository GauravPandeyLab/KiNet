...
#### Options
```{r,cache=FALSE}
checkboxInput(inputId='toggleOneDegree4', "Include adjacent proteins.", value = FALSE)
checkboxInput(inputId='toggleRemoveDisconnected4', "Exclude disconnected proteins.", value = TRUE)
```
...
## Main Panel
#### Description
This visualization shows proteins enriched in a particular <b>domain</b> from [InterPro](https://www.ebi.ac.uk/interpro/) and their kinase-substrate interactions. 
