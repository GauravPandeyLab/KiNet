...
Select a <b>domain</b> from [InterPro](https://www.ebi.ac.uk/interpro/) to see interactions between kinases and substrates containing the domain. Use the dropdown menu below.
