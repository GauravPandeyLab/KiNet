...
Visualize kinase-substrate interactions in curated [KEGG](https://www.genome.jp/kegg/pathway.html) **pathways**.  Use the dropdown menu below.

<p class='options-text'>
Pathways were selected by enriching against substrates in the KinAce interaction dataset. If the selected pathway only contains kinase substrates, you may not see any nodes or edges. Use the sidebar options to include more proteins.
</p>
