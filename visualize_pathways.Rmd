...
The dropdown menu lists `r npathways` out of `r npathways_all` pathways from the `r kegg_name` gene set library provided by [Enrichr](https://maayanlab.cloud/Enrichr/). 

The selected pathways were identified to be significantly enriched against the kinase substrates in the KinAce dataset using [GSEApy](https://github.com/zqfang/GSEApy/) <i>`r gseapy_release`</i>.
