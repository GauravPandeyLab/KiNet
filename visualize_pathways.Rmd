...
Select a <b>curated pathway</b>  from [KEGG](https://www.genome.jp/kegg/pathway.html) to see interactions between kinases and substrates in that pathway. Use the dropdown menu below.
...
<p>There may be none in the selected set. Use the options provided in <b>Include more proteins</b>. </p>
</div>