...
Pathways data source: </br> `r kegg_name` gene set library provided by [Enrichr](https://maayanlab.cloud/Enrichr/).

Enrichment analysis software: </br> [GSEApy](https://github.com/zqfang/GSEApy/) <i>`r gseapy_release`</i>.

For more details,see our [paper](https://doi.org/10.1101/2023.12.08.570875).



## Main Panel {data-width=1000}
#### Choose a pathway {.opening-page-text}
Visualize kinase-substrate interactions in select [KEGG](https://www.genome.jp/kegg/pathway.html) **pathways**.  Choose a pathway from the dropdown menu.

<p class='options-text'>
Pathways were selected by enriching against substrates in the KinAce interaction dataset. If a pathway only contains kinase substrates, you may not see any nodes or edges. Use the sidebar options to <b>include more proteins</b>.
</p>
